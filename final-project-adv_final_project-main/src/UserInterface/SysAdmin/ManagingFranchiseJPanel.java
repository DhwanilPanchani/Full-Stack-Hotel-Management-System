...
public class ManagingFranchiseJPanel extends javax.swing.JPanel {

    private SystemAdmin systemAdmin;
    private Runnable callOnCreateMethod;

    public ManagingFranchiseJPanel(SystemAdmin systemAdmin, Runnable callOnCreateMethod) {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UserInterface/SysAdmin/392561-blurred-gradient-748x421.jpg"))); // NOI18N
        jLabel2.setText("jLabel2");
        add(jLabel2);
        jLabel2.setBounds(-10, -140, 1966, 1358);
