...
public class ManagingServiceJPanel extends javax.swing.JPanel {

    private SystemAdmin systemAdmin;
    private Runnable callOnCreateMethod;

    public ManagingServiceJPanel(SystemAdmin systemAdmin, Runnable callOnCreateMethod) {
        initComponents();
    ...
    private void initComponents() {
        ...
        add(jLabel7);
        jLabel7.setBounds(360, 180, 183, 27);
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UserInterface/SysAdmin/392561-blurred-gradient-748x421.jpg"))); // NOI18N
        add(jLabel5);
