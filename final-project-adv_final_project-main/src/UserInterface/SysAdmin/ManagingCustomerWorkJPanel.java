...
public class ManagingCustomerWorkJPanel extends javax.swing.JPanel {

    private SystemAdmin systemAdmin;
    private Runnable callOnCreateMethod;

    public ManagingCustomerWorkJPanel(SystemAdmin systemAdmin, Runnable callOnCreateMethod) {
        initComponents();
    ...
    private void initComponents() {
        ...
        add(backButton);
        backButton.setBounds(50, 30, 72, 50);
        ...
        add(lblsysadmin);
        lblsysadmin.setBounds(430, 100, 450, 43);
        ...
        add(deleteBtn);
        deleteBtn.setBounds(720, 800, 93, 50);
        ...
        add(contactField);
        contactField.setBounds(500, 510, 168, 23);
        ...
        add(nameField);
        nameField.setBounds(500, 450, 168, 23);
        ...
        add(updateButton);
        updateButton.setBounds(540, 800, 97, 47);
        ...
        add(addressField);
        addressField.setBounds(500, 630, 168, 23);
        add(passwordField);
        passwordField.setBounds(930, 510, 160, 23);
        add(usernameField);
        usernameField.setBounds(930, 450, 160, 23);
        add(cityField);
        cityField.setBounds(500, 570, 168, 23);
        ...
        add(jLabel1);
        jLabel1.setBounds(0, -200, 1920, 1390);
