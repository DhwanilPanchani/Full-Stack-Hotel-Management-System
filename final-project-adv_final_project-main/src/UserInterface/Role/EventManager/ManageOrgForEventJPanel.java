package UserInterface.Role.EventManager;
...
public class ManageOrgForEventJPanel extends javax.swing.JPanel {
    ...
    public ManageOrgForEventJPanel(SystemAdmin systemAdmin, Runnable callOnCreateMethod, String user, String type, Franchise network) {
        initComponents();
    ...
    private void initComponents() {
        ...
        add(jLabel1);
        jLabel1.setBounds(540, 140, 591, 30);

        jLabel2.setFont(new java.awt.Font("Lucida Grande", 0, 18)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("ORGANISATION TYPE");
        add(jLabel2);
        jLabel2.setBounds(590, 620, 196, 22);

        orgCombo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select a organisation", "Decor", "Catering", "Photography" }));
        add(orgCombo);
        orgCombo.setBounds(830, 610, 210, 23);

        jLabel3.setFont(new java.awt.Font("Lucida Grande", 0, 18)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("NAME");
        add(jLabel3);
        jLabel3.setBounds(590, 680, 119, 22);
        add(nameField);
        nameField.setBounds(830, 680, 210, 23);

        jLabel4.setFont(new java.awt.Font("Lucida Grande", 0, 18)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("CONTACT");
        add(jLabel4);
        jLabel4.setBounds(590, 750, 119, 22);
        add(contactField);
        contactField.setBounds(830, 750, 210, 23);

        jLabel5.setFont(new java.awt.Font("Lucida Grande", 0, 18)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("CITY");
        add(jLabel5);
        jLabel5.setBounds(590, 820, 98, 22);
        ...
        add(deleteBtn);
        deleteBtn.setBounds(920, 910, 94, 39);
        ...
        add(updateBtn);
        updateBtn.setBounds(750, 910, 98, 37);
        ...
        cityNameTextField.setBounds(830, 810, 210, 23);

        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UserInterface/Role/EventManager/gradient_blur_abstraction_157512_300x168.jpg"))); // NOI18N
