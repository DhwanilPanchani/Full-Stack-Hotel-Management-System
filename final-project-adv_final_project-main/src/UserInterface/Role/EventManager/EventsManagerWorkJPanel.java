...
public class EventsManagerWorkJPanel extends javax.swing.JPanel {
    ...
    public EventsManagerWorkJPanel(SystemAdmin systemAdmin, Runnable callOnCreateMethod1, Runnable callOnCreateMethod2, Runnable callOnCreateMethod3) {
        initComponents();
    ...
    private void initComponents() {
        ...
        add(orgBtn);
        orgBtn.setBounds(460, 240, 313, 40);
        ...
        add(viewTask);
        viewTask.setBounds(460, 180, 313, 39);
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UserInterface/Role/EventManager/gif1.gif"))); // NOI18N
        jLabel3.setText("jLabel3");
        add(jLabel3);
        jLabel3.setBounds(190, 440, 920, 530);

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UserInterface/Role/EventManager/gradient_blur_abstraction_157512_300x168.jpg"))); // NOI18N
