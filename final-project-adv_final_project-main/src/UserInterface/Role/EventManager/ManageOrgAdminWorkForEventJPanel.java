...
public class ManageOrgAdminWorkForEventJPanel extends javax.swing.JPanel {
    ...
    public ManageOrgAdminWorkForEventJPanel(SystemAdmin systemAdmin, Runnable callOnCreateMethod, String user, String type, Franchise network) {
        initComponents();
    ...
    private void initComponents() {
        ...
        add(usernameField);
        usernameField.setBounds(955, 483, 176, 23);
        add(nameField);
        nameField.setBounds(955, 416, 176, 23);
        ...
        add(passwordField);
        passwordField.setBounds(955, 546, 176, 23);
        ...
        add(jLabel1);
        jLabel1.setBounds(331, 52, 553, 29);
        ...
        add(orgCombo);
        orgCombo.setBounds(389, 488, 208, 28);
        ...
        add(orgName);
        orgName.setBounds(389, 551, 261, 28);
        add(networkName);
        networkName.setBounds(389, 416, 216, 23);

        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UserInterface/Role/EventManager/gradient_blur_abstraction_157512_300x168.jpg"))); // NOI18N
