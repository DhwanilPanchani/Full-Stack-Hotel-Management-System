...
public class ViewTasksEventJPanel extends javax.swing.JPanel {
    ...
    public ViewTasksEventJPanel(SystemAdmin systemAdmin, Runnable callOnCreateMethod, String user, String type, BusinessEvent businessEvent) {
        initComponents();
    ...
    private void initComponents() {
        ...
        add(jLabel1);
        jLabel1.setBounds(470, 114, 457, 30);
        ...
        add(jLabel2);
        jLabel2.setBounds(310, 468, 212, 17);

        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("SELECT A DECOR ORG");
        add(jLabel3);
        jLabel3.setBounds(584, 471, 207, 17);

        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("SELECT A PHOTOGRAPHY ORG");
        add(jLabel4);
        jLabel4.setBounds(879, 468, 192, 17);

        add(cateringOrg);
        cateringOrg.setBounds(310, 514, 202, 23);

        add(decorOrg);
        decorOrg.setBounds(584, 514, 196, 23);

        add(photographyOrg);
        photographyOrg.setBounds(879, 514, 193, 23);
        ...
        add(denyButton);
        denyButton.setBounds(438, 779, 171, 41);

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UserInterface/Role/EventManager/gradient_blur_abstraction_157512_300x168.jpg"))); // NOI18N
