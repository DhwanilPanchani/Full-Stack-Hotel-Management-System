...
public class HealthClubsManagerWorkJPanel extends javax.swing.JPanel {
    ...
    public HealthClubsManagerWorkJPanel(SystemAdmin systemAdmin, Runnable callOnCreateMethod1, Runnable callOnCreateMethod2, Runnable callOnCreateMethod3) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UserInterface/Role/HealthClubManager/ezgif.com-optimize.gif"))); // NOI18N
        add(jLabel3);
        jLabel3.setBounds(390, 530, 970, 530);

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UserInterface/Role/HealthClubManager/imagesss.jpg"))); // NOI18N
        add(jLabel2);
        jLabel2.setBounds(0, -940, 4500, 2950);
