...
public class ViewTaskRestaurantWorkJPanel extends javax.swing.JPanel {
    ...
    public ViewTaskRestaurantWorkJPanel(SystemAdmin systemAdmin, Runnable callOnCreateMethod, String user, String type, Restaurant restaurant) {
        initComponents();
    ...
    private void initComponents() {
        ...
        add(jLabel2);
        jLabel2.setBounds(460, 320, 511, 30);

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UserInterface/Role/RestaurantManager/2527bd3e3997e00a69a0dbc7677e4bc7.jpg"))); // NOI18N
        add(jLabel3);
        jLabel3.setBounds(0, -130, 1600, 1162);
