...
public class ManagingOrganisationAdminRestauarantJPanel extends javax.swing.JPanel {
    ...
    public ManagingOrganisationAdminRestauarantJPanel(SystemAdmin systemAdmin, Runnable callOnCreateMethod, String user, String type, Franchise network) {
        initComponents();
...
//    }
    ...
    private void initComponents() {
        ...
        add(orgCombo);
        orgCombo.setBounds(510, 630, 197, 28);
        ...
        add(networkName);
        networkName.setBounds(510, 570, 197, 23);

        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UserInterface/Role/RestaurantManager/2527bd3e3997e00a69a0dbc7677e4bc7.jpg"))); // NOI18N
        add(jLabel8);
        jLabel8.setBounds(0, -130, 1600, 1162);
