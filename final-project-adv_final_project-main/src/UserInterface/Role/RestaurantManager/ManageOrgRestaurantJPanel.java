...
public class ManageOrgRestaurantJPanel extends javax.swing.JPanel {
    ...
    public ManageOrgRestaurantJPanel(SystemAdmin systemAdmin, Runnable callOnCreateMethod, String user, String type, Franchise network) {
        initComponents();
    ...
    private void initComponents() {
        ...
        cityNameTextField.setBounds(890, 690, 232, 23);
        ...
        add(deleteBtn);
        deleteBtn.setBounds(1010, 780, 93, 39);
        ...
        add(updateButton);
        updateButton.setBounds(730, 780, 97, 39);

        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UserInterface/Role/RestaurantManager/2527bd3e3997e00a69a0dbc7677e4bc7.jpg"))); // NOI18N
        add(jLabel6);
        jLabel6.setBounds(0, -130, 1600, 1162);
