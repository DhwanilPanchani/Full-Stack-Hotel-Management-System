...
public class AddingOrderJPanel extends javax.swing.JPanel {
    ...
    public AddingOrderJPanel(SystemAdmin systemAdmin, Runnable callOnCreateMethod, String user, String type, Franchise network) {
        initComponents();
    ...
    private void initComponents() {
        ...
        add(addBtn);
        addBtn.setBounds(660, 790, 112, 27);
        ...
        add(priceField);
        priceField.setBounds(630, 730, 177, 23);
        ...
        add(jLabel2);
        jLabel2.setBounds(0, -130, 1600, 1162);
