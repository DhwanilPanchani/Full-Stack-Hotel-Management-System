...
public class AddingServicesJPanel extends javax.swing.JPanel {
    ...
    public AddingServicesJPanel(SystemAdmin systems, Consumer<Booking> callOnEventBooking, Consumer<Booking> callOnOrderBooking,
    ...
    private void initComponents() {
        ...
        add(jLabel1);
        jLabel1.setBounds(643, 110, 283, 43);
        ...
        add(eventBtn);
        eventBtn.setBounds(610, 180, 308, 38);
        ...
        add(orderBtn);
        orderBtn.setBounds(610, 320, 308, 42);
        ...
        add(healthClubBtn);
        healthClubBtn.setBounds(610, 250, 308, 42);
        ...
        add(otherService);
        otherService.setBounds(610, 380, 308, 38);

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UserInterface/Role/Customer/services.gif"))); // NOI18N
        add(jLabel3);
        jLabel3.setBounds(360, 470, 840, 460);

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UserInterface/Role/Customer/gradient_pink_shades_130856_300x168.jpg"))); // NOI18N
        jLabel2.setText("jLabel2");
        add(jLabel2);
        jLabel2.setBounds(-9, -200, 1966, 1330);
