...
public class HealthServiceClubJPanel extends javax.swing.JPanel {
    ...
    public HealthServiceClubJPanel(SystemAdmin systems, Consumer<Booking> callOnCreateMethod1, String username, Booking booking) {
        initComponents();
    ...
    private void initComponents() {
        ...
        add(yogaBtn);
        yogaBtn.setBounds(213, 361, 119, 26);
        ...
        add(massageBtn);
        massageBtn.setBounds(213, 442, 229, 26);
        ...
        medicalServiceBtn.setBounds(213, 532, 229, 26);
        ...
        add(addServiceBtn);
        addServiceBtn.setBounds(380, 662, 141, 43);
        ...
        add(jLabel7);
        jLabel7.setBounds(240, 173, 139, 22);
        add(dateField);
        dateField.setBounds(540, 173, 227, 23);
        ...
        add(healthClubCombo);
        healthClubCombo.setBounds(540, 266, 230, 23);

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UserInterface/Role/Customer/gradient_pink_shades_130856_300x168.jpg"))); // NOI18N
        jLabel1.setText("jLabel1");
        add(jLabel1);
        jLabel1.setBounds(0, 0, 1966, 1075);
