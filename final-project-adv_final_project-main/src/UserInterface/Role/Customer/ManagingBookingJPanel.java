...
public class ManagingBookingJPanel extends javax.swing.JPanel {
    ...
    public ManagingBookingJPanel(SystemAdmin systemAdmin, Runnable callOnCreateMethod1, Consumer<Booking> callOnCreateMethod2, Consumer<Booking> callOnViewServiceMethod, String username) {
        initComponents();
