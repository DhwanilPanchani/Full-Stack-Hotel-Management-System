package UserInterface.Role.Customer;
...
public class BookingEventJPanel extends javax.swing.JPanel {
    ...
    public BookingEventJPanel(SystemAdmin systems, Consumer<Booking> callOnCreateMethod1, String username, Booking booking) {
        initComponents();
    ...
    private void initComponents() {
        ...
        add(photoRadioBtn);
        photoRadioBtn.setBounds(193, 329, 148, 26);
        ...
        cateringRadioBtn.setBounds(193, 426, 108, 26);
        ...
        add(bookEventBtn);
        bookEventBtn.setBounds(344, 761, 137, 38);
        ...
        add(jLabel1);
        jLabel1.setBounds(193, 474, 159, 22);
        ...
        add(decorRadioBtn);
        decorRadioBtn.setBounds(193, 545, 165, 26);
        ...
        add(jLabel2);
        jLabel2.setBounds(200, 176, 98, 22);
        add(dateField);
        dateField.setBounds(453, 176, 210, 23);

        add(orgComboBox);
        orgComboBox.setBounds(453, 261, 210, 23);

        jLabel4.setFont(new java.awt.Font("Lucida Grande", 0, 18)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("BUSINESS EVENTS ");
        add(jLabel4);
        jLabel4.setBounds(200, 267, 158, 22);
        ...
        add(totalPrice);
        totalPrice.setBounds(206, 687, 160, 27);

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UserInterface/Role/Customer/gradient_pink_shades_130856_300x168.jpg"))); // NOI18N
        jLabel3.setText("jLabel3");
        add(jLabel3);
        jLabel3.setBounds(0, 0, 1966, 1040);
