...
public class BookRoomServicesJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(peopleField);
        peopleField.setBounds(498, 348, 342, 23);
        add(roomField);
        roomField.setBounds(502, 488, 334, 23);
        add(checkin);
        checkin.setBounds(502, 134, 171, 23);
        ...
        add(checkout);
        checkout.setBounds(703, 134, 153, 23);
        ...
        add(jLabel1);
        jLabel1.setBounds(170, 425, 120, 22);
        ...
        roomtypeComboBox.setBounds(498, 419, 334, 23);
        ...
        add(priceBtn);
        priceBtn.setBounds(231, 597, 142, 28);

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UserInterface/Role/Customer/gif4.gif"))); // NOI18N
        add(jLabel3);
