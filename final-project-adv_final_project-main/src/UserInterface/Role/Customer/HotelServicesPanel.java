...
public class HotelServicesPanel extends javax.swing.JPanel {
    ...
    public HotelServicesPanel(SystemAdmin systems, Consumer<Booking> callOnCreateMethod1, String username, Booking booking) {
        initComponents();
    ...
    private void initComponents() {
        ...
        add(jLabel1);
        jLabel1.setBounds(226, 77, 423, 43);
        ...
        laundaryBtn.setBackground(new java.awt.Color(102, 102, 255));
        ...
        add(laundaryBtn);
        laundaryBtn.setBounds(312, 301, 317, 26);
        ...
        transportationBtn.setBounds(312, 392, 332, 26);
        ...
        add(jLabel3);
        jLabel3.setBounds(182, 199, 75, 22);
        ...
        add(jLabel2);
        jLabel2.setBounds(0, 0, 1966, 1075);
