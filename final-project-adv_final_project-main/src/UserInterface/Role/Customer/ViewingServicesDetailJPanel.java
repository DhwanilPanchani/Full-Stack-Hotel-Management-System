...
public class ViewingServicesDetailJPanel extends javax.swing.JPanel {
    ...
    public ViewingServicesDetailJPanel(SystemAdmin systems, Runnable callOnCreateMethod1, String username, Booking booking) {
        initComponents();
    ...
    private void initComponents() {
        ...
        add(jLabel1);
        jLabel1.setBounds(344, 108, 93, 22);

        jLabel2.setFont(new java.awt.Font("Lucida Grande", 0, 18)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("CHECK-OUT");
        add(jLabel2);
        jLabel2.setBounds(327, 155, 106, 22);

        checkout.setFont(new java.awt.Font("Lucida Grande", 0, 14)); // NOI18N
        add(checkout);
        checkout.setBounds(610, 154, 249, 23);
        add(jTextField1);
        ...
        add(checkin);
        checkin.setBounds(610, 107, 249, 23);

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UserInterface/Role/Customer/gradient_pink_shades_130856_300x168.jpg"))); // NOI18N
        jLabel4.setText("EMAIL STATEMENT");
        add(jLabel4);
        jLabel4.setBounds(0, -3, 2038, 1070);
