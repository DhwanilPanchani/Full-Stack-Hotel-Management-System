...
public class CustomerStartJPanel extends javax.swing.JPanel {
    ...
    public CustomerStartJPanel(SystemAdmin systemAdmin, Runnable callOnCreateMethod1, Runnable callOnCreateMethod2) {
        initComponents();
