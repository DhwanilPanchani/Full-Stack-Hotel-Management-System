...
public class RestuarantServicesJPanel extends javax.swing.JPanel {
    ...
    public RestuarantServicesJPanel(SystemAdmin systems, Consumer<Booking> callOnCreateMethod1, String username, Booking booking) {
        initComponents();
    ...
    private void initComponents() {
        ...
        add(menuItem);
        menuItem.setBounds(402, 332, 336, 23);
        ...
        add(jLabel1);
        jLabel1.setBounds(90, 91, 603, 43);
        ...
        add(restaurantCombo);
        restaurantCombo.setBounds(402, 237, 327, 23);
