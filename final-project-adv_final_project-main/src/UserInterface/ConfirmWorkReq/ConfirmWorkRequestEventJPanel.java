package UserInterface.ConfirmWorkReq;
...
public class ConfirmWorkRequestEventJPanel extends javax.swing.JPanel {

    private SystemAdmin systemAdmin;
    private String user;
    private String type;

    public ConfirmWorkRequestEventJPanel(SystemAdmin systemAdmin, String user, String type) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UserInterface/ConfirmWorkReq/vector-jan-2021-19_generated.jpg"))); // NOI18N
