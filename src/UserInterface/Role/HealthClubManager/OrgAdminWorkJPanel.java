package UserInterface.Role.HealthClubManager;

import java.util.List;
import javax.swing.JOptionPane;
import javax.swing.table.DefaultTableModel;
import model.ServicesDirectory;
...
import UserInterface.Main.Validator;

public class OrgAdminWorkJPanel extends javax.swing.JPanel {
    ...
    public OrgAdminWorkJPanel(SystemAdmin systemAdmin, Runnable callOnCreateMethod, String user, String type, Franchise network) {
        initComponents();
    ...
    private void initComponents() {
        ...
        add(orgCombo);
        orgCombo.setBounds(490, 431, 199, 28);

        jLabel2.setFont(new java.awt.Font("Lucida Grande", 0, 18)); // NOI18N
        jLabel2.setText("NAME");
        add(jLabel2);
        jLabel2.setBounds(826, 363, 67, 22);

        nameField.setFont(new java.awt.Font("Lucida Grande", 0, 14)); // NOI18N
        add(nameField);
        nameField.setBounds(948, 362, 183, 23);

        jLabel3.setFont(new java.awt.Font("Lucida Grande", 0, 18)); // NOI18N
        jLabel3.setText("USERNAME");
        add(jLabel3);
        jLabel3.setBounds(826, 432, 104, 22);
        add(usernameField);
        usernameField.setBounds(948, 426, 183, 23);

        jLabel4.setFont(new java.awt.Font("Lucida Grande", 0, 18)); // NOI18N
        jLabel4.setText("PASSWORD");
        add(jLabel4);
        jLabel4.setBounds(826, 496, 95, 22);
        add(passwordField);
        passwordField.setBounds(948, 490, 186, 23);
        ...
        add(jLabel5);
        jLabel5.setBounds(274, 496, 197, 22);

        orgName.setFont(new java.awt.Font("Lucida Grande", 0, 14)); // NOI18N
        add(orgName);
        orgName.setBounds(487, 495, 202, 23);
        ...
        add(networkName);
        networkName.setBounds(491, 357, 190, 23);

        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UserInterface/Role/HealthClubManager/imagesss.jpg"))); // NOI18N
        ...
        add(jLabel8);
        jLabel8.setBounds(274, 363, 101, 22);
