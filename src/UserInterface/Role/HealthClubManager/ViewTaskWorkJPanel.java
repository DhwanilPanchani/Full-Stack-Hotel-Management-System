...
import servicesProject.HealthClubService;
import servicesProject.Service;
import javax.swing.ImageIcon;

public class ViewTaskWorkJPanel extends javax.swing.JPanel {
    ...
    public ViewTaskWorkJPanel(SystemAdmin systemAdmin, Runnable callOnCreateMethod, String user, String type, HealthClub healthClub) {
        initComponents();
    ...
    private void initComponents() {
        ...
        add(jLabel3);
        jLabel3.setBounds(937, 456, 246, 22);

        jLabel4.setFont(new java.awt.Font("Lucida Grande", 0, 18)); // NOI18N
        jLabel4.setText("SELECT A TRAINER ORG");
        add(jLabel4);
        jLabel4.setBounds(614, 456, 238, 22);

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UserInterface/Role/HealthClubManager/imagesss.jpg"))); // NOI18N
