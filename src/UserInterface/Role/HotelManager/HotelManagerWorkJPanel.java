...
public class HotelManagerWorkJPanel extends javax.swing.JPanel {
    ...
    public HotelManagerWorkJPanel(SystemAdmin systemAdmin, Runnable callOnCreateMethod1, Runnable callOnCreateMethod2, Runnable callOnCreateMethod3, Runnable callOnCreateMethod4) {
        initComponents();
    ...
    private void initComponents() {
        ...
        add(orgAdminBtn);
        orgAdminBtn.setBounds(570, 460, 310, 90);
        ...
        add(orgBtn);
        orgBtn.setBounds(570, 330, 312, 90);
        ...
        add(viewTask);
        viewTask.setBounds(570, 200, 312, 90);
        ...
        add(manageRooms);
        manageRooms.setBounds(570, 580, 320, 90);

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UserInterface/Role/HotelManager/sunrise1.jpg"))); // NOI18N
