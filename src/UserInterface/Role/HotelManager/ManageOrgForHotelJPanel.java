...
public class ManageOrgForHotelJPanel extends javax.swing.JPanel {
    ...
    public ManageOrgForHotelJPanel(SystemAdmin systemAdmin, Runnable callOnCreateMethod, String user, String type, Franchise network) {
        initComponents();
    ...
    private void initComponents() {
        ...
        add(updateButton);
        updateButton.setBounds(620, 820, 97, 41);
