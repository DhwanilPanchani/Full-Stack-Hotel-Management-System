package UserInterface.Role.HotelManager;
...
public class ManageOrgAdminForHotelJPanel extends javax.swing.JPanel {
    ...
    public ManageOrgAdminForHotelJPanel(SystemAdmin systemAdmin, Runnable callOnCreateMethod, String user, String type, Franchise network) {
        initComponents();
    ...
    private void initComponents() {
        ...
        add(nameField);
        nameField.setBounds(900, 480, 144, 23);
        ...
        add(orgCombo);
        orgCombo.setBounds(480, 550, 187, 23);
        ...
        add(updateButton);
        updateButton.setBounds(580, 750, 97, 39);
        ...
        add(usernameField);
        usernameField.setBounds(900, 550, 144, 23);
        add(passwordField);
        passwordField.setBounds(900, 630, 144, 23);
        ...
        add(deleteButton);
        deleteButton.setBounds(760, 750, 93, 40);
        ...
        add(orgName);
        orgName.setBounds(480, 630, 187, 23);
        add(networkName);
        networkName.setBounds(480, 470, 180, 23);

        jLabel7.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UserInterface/Role/HotelManager/sunrise1.jpg"))); // NOI18N
