...
import servicesProject.HotelService;
import servicesProject.Service;
import javax.swing.ImageIcon;

public class ViewTaskHotelJPanel extends javax.swing.JPanel {
    ...
    public ViewTaskHotelJPanel(SystemAdmin systemAdmin, Runnable callOnCreateMethod, String user, String type, Hotel hotel) {
        initComponents();
    ...
    private void initComponents() {
        ...
        add(jLabel1);
        jLabel1.setBounds(410, 480, 242, 22);
        ...
        add(laundaryOrg);
        laundaryOrg.setBounds(410, 530, 202, 23);

        jLabel2.setFont(new java.awt.Font("Lucida Grande", 0, 18)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("SELECT A TRANSPORTATION ORG");
        add(jLabel2);
        jLabel2.setBounds(750, 480, 289, 22);
        ...
        transportationOrg.setBounds(750, 520, 216, 23);
        ...
        add(viewTask);
        viewTask.setBounds(560, 630, 256, 46);
        ...
        add(jLabel3);
        jLabel3.setBounds(500, 120, 630, 43);

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UserInterface/Role/HotelManager/sunrise1.jpg"))); // NOI18N
